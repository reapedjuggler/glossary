    ...
    const params = {
        ...
        Message: {
            Body: {
                Html: {
                    Charset: 'UTF-8',
                    Data: "Hallo from Moyyn!<br>You have requested to reset the password in Moyyn.<br><br>Email address: rb@gmail.com<br>Password: "+pass+"<br><br>Please use this temporary one time password to login now and update your new password.<br>Best regards,<br>Moyyn"
                },
